...
PYBIND11_MODULE(_isl, m)
{
  ...
  */
  ...
  py::enum_<isl_ast_loop_type>(m, "ast_loop_type")
    ...
    ;
  py::enum_<isl_autosa_loop_type>(m, "autosa_loop_type")
    .ENUM_VALUE(isl_autosa_loop_, error)
    .ENUM_VALUE(isl_autosa_loop_, default)
    .ENUM_VALUE(isl_autosa_loop_, time)
    .ENUM_VALUE(isl_autosa_loop_, space)
    .ENUM_VALUE(isl_autosa_loop_, latency)
    .ENUM_VALUE(isl_autosa_loop_, simd)
    .ENUM_VALUE(isl_autosa_loop_, array_part)
    ;
